    ...
    <View style={styles.container}>
      {showConfirm ? (
        <View style={styles.confirmContainer}>
          ...
          <Text>
            <Text style={[styles.promptText, { padding: 5 }]}>Date: </Text>
            <Text style={styles.inputText}>{date}</Text>
          </Text>
          <Text>
            <Text style={[styles.promptText, { padding: 5 }]}>
              Fog Net ID #:{" "}
            </Text>
            <Text style={styles.inputText}>{fogNetID}</Text>
          </Text>
          <Text>
            <Text style={[styles.promptText, { padding: 5 }]}>
              Cluster ID #:{" "}
            </Text>
            <Text style={styles.inputText}>{clusterID}</Text>
          </Text>
          <Text>
            <Text style={[styles.promptText, { padding: 5 }]}>
              Model Name:{" "}
            </Text>
            <Text style={styles.inputText}>{fogNetModel}</Text>
          </Text>
          <Text>
            <Text style={[styles.promptText, { padding: 5 }]}>
              Water Collected (L):{" "}
            </Text>
            <Text style={styles.inputText}>{waterCollected}</Text>
          </Text>
          <View style={styles.rowContainer}>
            <TouchableOpacity
              style={[styles.confirmButton, { backgroundColor: "#9fd4a3" }]}
              onPress={async () => {
                handleShowModal();
              }}
            >
            ...
            <TouchableOpacity
              style={[styles.confirmButton, { backgroundColor: "#fe8e86" }]}
              onPress={async () => {
        ...
        <View style={styles.container}>
          <Text
            style={[styles.headerText, { paddingLeft: 105, paddingRight: 105 }]}
          >
            New Entry
          </Text>
